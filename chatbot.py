...
Original file is located at
    https://colab.research.google.com/drive/1tk0MlB6-Z4nBC2dqH3NArWr-yeFAOSwW
"""
...
pairs = [
    ...
    [
        r"(.*)created(.*)",
        ["Naren created me using Python's NLTK library ","Its top secret........... ;)",]
    ],
    [
        r"(.*) (location|city) ?",
        ['TamilNadu , India',]
